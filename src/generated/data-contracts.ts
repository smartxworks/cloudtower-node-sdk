...
export type IscsiLunUpdationParamsData = { assigned_size?: number; name?: string } & IscsiLunCommonParams;
...
export type NvmfNamespaceUpdationParamsData = { assigned_size?: number; name?: string } & NvmfNamespaceCommonParams;
...
export interface ReportTemplateUpdationParams {
  data: { resource_meta?: ResourceMeta[]; execute_plan?: ExecutePlan[]; description?: string; name?: string };
...
export interface VdsUpdationParams {
  data: { nicIds?: string[]; work_mode?: string; bond_mode?: string; name?: string };
  where: VdsWhereInput;
}
...
export interface ManagementVlanUpdationParams {
  data: { extra_ip?: ExtraIp[]; subnetmask?: string; gateway_ip?: string; vlan_id?: number };
  where: VlanWhereInput;
}
...
export interface VmUpdateNicAdvanceInfoParams {
  data: { mirror?: boolean; enabled?: boolean; mac_address?: string; nic_id?: string; connect_vlan_id?: string };
  where: VmNicWhereInput;
}
...
export interface VmUpdateAdvancedOptionsParams {
  data: { video_type?: VmVideoType; windows_optimize?: boolean; cpu_model?: string; clock_offset?: VmClockOffset };
  where: VmWhereInput;
}
