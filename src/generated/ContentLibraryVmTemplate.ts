...
export class ContentLibraryVmTemplateApi<SecurityDataType = unknown> {
   ...
   */
  cloneContentLibraryVmTemplateFromVm = (data: ContentLibraryVmTemplateCreationParams[], params: RequestParams = {}) =>
   ...
   * @response `500` `ErrorBody` Server error
   */
  updateContentLibraryVmTemplate = (data: ContentLibraryVmTemplateUpdationParams, params: RequestParams = {}) =>
    this.http.request<WithTaskContentLibraryVmTemplate[], ErrorBody>({
   ...
   * @response `500` `ErrorBody` Server error
   */
  deleteContentLibraryVmTemplate = (data: ContentLibraryVmTemplateDeletionParams, params: RequestParams = {}) =>
